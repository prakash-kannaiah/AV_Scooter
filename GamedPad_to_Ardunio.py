...
# Open serial port
SerialObj = serial.Serial('COM8')  # for WIndows; Adjust 'COM8' to match your serial port
#SerialObj = serial.Serial('/dev/ttyACM0') # for Jetson
SerialObj.baudrate = 9600           # Set Baud rate to 9600
SerialObj.bytesize = 8              # Number of data bits = 8
SerialObj.parity = 'N'              # No parity
SerialObj.stopbits = 1              # Number of Stop bits = 1

time.sleep(3)  # Wait for the serial connection to stabilize
...
if __name__ == '__main__':
    try:
        ...
        while True:
            ...
            # Convert string to bytes before writing to serial port
            data_bytes = json_data_with_newline.encode('utf-8')
            
            SerialObj.write(data_bytes)         # Transmit the data
            print(data)
            pass
